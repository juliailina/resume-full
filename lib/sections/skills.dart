    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          TextBox(
            text:
                'So far I have learnt about: Flutter & Dart basics, State Management, Animations, Navigation, Packages, Custom Painter, Firebase, APIs, OOP principles, SOLID, DRY-code, Command Line operations, Git, Kotlin Basics, UX/UI principles in Digital Product Design using Figma and more. Constantly adding to the list.\n\nAreas of future improvement: State Management w/ BLoC, Redux, Cubit etc., SQL, Swift, deepen software architecture knowledge (clean code principles, OOP design patterns), Testing and any other skills required for the job.\n\nSoft skills: good communication, problem-solving, self-learning and collaboration skills. High level of empathy and helpfulness. I consider myself a creative and open-minded person who easily adapts to new environments and technologies.\n\nLanguages: fluent levels of English (C1), Spanish (C1) and Russian (native). Good understanding of Ukrainian (lack spoken and written practice). Limited working proficiency in German (B1) and elementary in Czech (A2).',
          ),
        ],
      ),
    );
